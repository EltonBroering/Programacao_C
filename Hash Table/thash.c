...
void * obtemItemTabela(THash tabela, char * chave);
...
void adicionaItemTabela(THash tabela, char * chave, void * dados);
 
// Remove um dado associado a uma determinada chave (e o retorna).
void * removeItemTabela(THash tabela, char * chave);
...
// armazenado na tabela. Funcoes como essa devem retornae uma representacao em string de
